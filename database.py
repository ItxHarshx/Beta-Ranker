...
async def connect_db():
    return await asyncpg.connect("postgresql://postgres:PfnWgQeRbPRPBDpFTQYnDOsnDrYcSyxH@gondola.proxy.rlwy.net:32947/railway")  # Change credentials!
...
async def get_top_users(category):
    ...
    conn = await asyncpg.connect("postgresql://postgres:PfnWgQeRbPRPBDpFTQYnDOsnDrYcSyxH@gondola.proxy.rlwy.net:32947/railway")
